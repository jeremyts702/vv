...
// Multer configuration for file uploads (ensure the destination path is correct)
...
const storage = multer.diskStorage({
    destination: function (req, file, cb) {
        cb(null, uploadsDir); // Corrected: Save files to the dynamically created 'uploadsDir'
    },
...
const upload = multer({ storage: storage }); // 'upload' instance for other potential file uploads
